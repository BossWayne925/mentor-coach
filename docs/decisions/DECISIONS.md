...
[2026-06-06 #11] DECISION: Goals (4 files: active-arc, 90-day-picture, weekly-commitments, if-then-plans), Skills (7 coaching moves: score-the-day, challenge-distortion, slip-recovery, finish-push, study-or-stall, future-self-pull, if-then-deploy), Hooks (4 triggers: morning-checkin, evening-checkin, weekly-review, slip-detected). Daily check-in is morning + evening. | WHY: 7 skills map naturally from the trigger table and Wayne's weaknesses. Two daily touches create rhythm. If-then plans pre-load responses so willpower isn't the only defense. | STATUS: locked
